...
<?php include('../includes/alert.php'); ?>
        <form method="POST" action="store.php" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="cost" placeholder="Enter item cost price" name="cost_price" value="<?php echo $_SESSION['cost']; ?>">
                <small><?php 
                ...
                <input type="text" class="form-control" id="sell" placeholder="Enter sell price" name="sell_price" value="<?php echo $_SESSION['sell']; ?>">
